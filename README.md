...
<p align="center">
  <img src="https://komarev.com/ghpvc/?username=iamahsanmehmood&style=for-the-badge&color=6C63FF" alt="Profile Views"/>
  <img src="https://img.shields.io/github/followers/iamahsanmehmood?style=for-the-badge&color=6C63FF" alt="Followers"/>
</p>
...
role: Full-Stack Software Developer & Technical Founder
...
|---|---|
| **Expert** 🟢 | C#, .NET Framework, WinForms, SQL Server |
| **Advanced** 🟡 | ASP.NET, React, TypeScript, Entity Framework, AWS, Flutter |
| **Intermediate** 🔵 | Python, PHP/Laravel, Ruby, Dart, Node.js, Vite, Three.js, Google Cloud |
| **Specialized** ⚡ | LLM/AI Integration, PDF Automation, 3D/AR (Three.js), CAD/DXF Processing, Revit API, SketchUp API |
...
#### 🍽️ RestoCare+ POS
Multi-terminal restaurant POS with thermal printing, real-time table management, and kitchen display integration.
...
#### 📄 EstiMate Pro
AI-powered PDF automation tool with WYSIWYG coordinate mapping, auto-advance workflows, and WhatsApp integration.
> **Tech:** Flutter · Dart · PDF Processing
...
#### 🏗️ Engineering Suite (MODCON)
7+ structural engineering tools — joist analysis, truss indexing, steel estimation, DXF import — for RPEQ-certified projects in Australia.
> **Tech:** C# · .NET · AutoCAD · SketchUp Ruby API

</td>
<td width="50%" valign="top">

#### 🌐 PAL Government Website
Full website for Pakistan Academy of Letters + DLP Flutter app for the national literary institution.
...
#### 📚 Booktionary
Dictionary & book management app with offline storage, smart search, and synchronized data.
...
#### 🤖 AI Projects
AutoCAD AI Agent for automated floor plans + Gemini PC-Commander for voice-controlled system automation.
> **Tech:** Python · Gemini API · LLM Integration

</td>
</tr>
</table>

<p align="center"><i>...and 30+ more projects including MartCare POS, ClothWarehouse Accounting, Payroll Systems, Hamari Urdu, IFC Viewer, and more.</i></p>
